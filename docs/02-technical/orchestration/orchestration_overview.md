...
2. **[Main Processing Layer](./main_processing.md)**
   ...
   * Database Loader
3. **[PDF Processing Layer](./pdf-processing.md)**
...
5. **[Dependency Graph](./dependency_graph.md)**
   ...
   * Execution DAGs
6. **[Airflow DAGs](../../../airflow/README.md)**
   * Production pipelines are now managed via Airflow.
   * See `airflow/dags/realmap_etl_dag.py`.
